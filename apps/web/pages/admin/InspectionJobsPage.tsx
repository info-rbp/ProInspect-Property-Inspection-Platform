      ...
      {isCreating ? (
        <form {...dirtyForm.formProps} onSubmit={handleSubmit} className="rounded-2xl border border-stone-200 bg-white shadow-sm">
          ...
          <div className="grid gap-5 p-5 lg:grid-cols-3">
            ...
            {template ? <div className="rounded-xl border border-stone-200 bg-stone-50 p-4 lg:col-span-3"><p className="text-xs font-bold uppercase tracking-wider text-stone-500">Immutable template assignment</p><p className="mt-2 font-bold capitalize text-stone-950">{template.inspectionType} · {template.propertyType} · v{template.version}</p><p className="mt-1 truncate font-mono text-[10px] text-stone-600">{template.contentHash}</p></div> : null}
