...
const AgencyAdminPage = React.lazy(() => import('./pages/admin/AgencyAdminPage'));
const ClientsPage = React.lazy(() => import('./pages/admin/ClientsPage'));
const TenanciesPage = React.lazy(() => import('./pages/admin/TenanciesPage'));
    ...
    <Route path="/app" element={<ProtectedRoute />}>
      <Route element={<AppShell />}>
        ...
        <Route element={<RoleProtectedRoute section="properties" />}>
          ...
          <Route path="admin/tenancies" element={<TenanciesPage />} />
        </Route>
        <Route element={<RoleProtectedRoute section="jobs" />}><Route path="admin/jobs" element={<InspectionJobsPage />} /><Route path="admin/jobs/:jobId" element={<InspectionJobDetailPage />} /><Route path="admin/work-queue" element={<WorkQueuePage />} /></Route>
        <Route element={<RoleProtectedRoute section="reports" />}><Route path="admin/reports" element={<ReportsPage />} /><Route path="admin/reports/:reportId" element={<ReportDetailPage />} /><Route path="admin/reports/:reportId/edit" element={<ReportEditPage />} /><Route path="admin/reports/:reportId/preview" element={<ReportPreviewPage />} /><Route path="admin/reports/:reportId/review" element={<ReviewWorkspacePage />} /></Route>
        ...
        <Route element={<RoleProtectedRoute section="settings" />}><Route path="admin/agency" element={<AgencyAdminPage />} /><Route path="admin/settings" element={<SettingsPage />} /></Route>
      </Route>
    </Route>
